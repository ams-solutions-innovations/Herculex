        ...
        return PrimaryLayout.Builder(deviceParameters)
            ...
            .setContent(
                Text.Builder(this, "$calories kcal")
                    ...
                    .setColor(androidx.wear.protolayout.ColorBuilders.argb(android.graphics.Color.WHITE))
                    .build()
            )
            .setSecondaryLabelTextContent(
                Text.Builder(this, "${protein}g protein")
                    .setTypography(Typography.TYPOGRAPHY_BODY1)
                    .setColor(androidx.wear.protolayout.ColorBuilders.argb(android.graphics.Color.LTGRAY))
                    .build()
            )
            .build()
    }
