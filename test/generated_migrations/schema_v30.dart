...
class RepTrackingSettings extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  RepTrackingSettings(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  RepTrackingSettings createAlias(String alias) {
    return RepTrackingSettings(attachedDatabase, alias);
  }
}

class RepTrackingExercisePrefs extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  RepTrackingExercisePrefs(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  RepTrackingExercisePrefs createAlias(String alias) {
    return RepTrackingExercisePrefs(attachedDatabase, alias);
  }
}

class RepSetObservations extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  RepSetObservations(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  RepSetObservations createAlias(String alias) {
    return RepSetObservations(attachedDatabase, alias);
  }
}
...
class DatabaseAtV30 extends GeneratedDatabase {
  ...
  late final RepTrackingSettings repTrackingSettings = RepTrackingSettings(
    this,
  );
  late final RepTrackingExercisePrefs repTrackingExercisePrefs =
      RepTrackingExercisePrefs(this);
  late final RepSetObservations repSetObservations = RepSetObservations(this);
